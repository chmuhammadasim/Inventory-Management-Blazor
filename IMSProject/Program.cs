...
using IMSProject.Areas.Identity;
...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("ManagementSystem"));
});
...
builder.Services.AddTransient<IValidateEnoughInventoriesForProductUseCase, ValidateEnoughInventoriesForProductUseCase>();
